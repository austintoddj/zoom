...
mix.js('resources/assets/admin/js/admin.js', 'public/js')
    ...
    .copy('resources/assets/vendor/css/toolkit-inverse.css', 'public/vendor/css')
    .copy('resources/assets/vendor/css/application.css', 'public/vendor/css')
    .copy('resources/assets/vendor/js/chart.js', 'public/vendor/js')
    .copy('resources/assets/vendor/js/tablesorter.min.js', 'public/vendor/js')
